...
describe('ClassName', () => {
  test('Has default className', () => {
    const wrapper = shallow(<Emoticon name="happy" />)
  ...
  test('Applies custom className if specified', () => {
    ...
    const wrapper = shallow(<Emoticon name="happy" className={className} />)
...
describe('Interactions', () => {
  test('Add ignoreClick styles if applied', () => {
    const wrapper = shallow(<Emoticon name="emoji" clickable={false} />)
...
describe('Sizes', () => {
  test('Add sizing styles if applied', () => {
    const wrapper = shallow(<Emoticon name="happy" size="sm" />)

    expect(wrapper.hasClass('is-sm')).toBe(true)
  })

  test('Has size md', () => {
    const wrapper = shallow(<Emoticon name="happy" size="md" />)
